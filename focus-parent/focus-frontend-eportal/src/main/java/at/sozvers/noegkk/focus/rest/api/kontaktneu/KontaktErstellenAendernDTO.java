...
public class KontaktErstellenAendernDTO implements BaseDTO {
  ...
  @JsonDeserialize(using=LocalDateTimeDeserializer.class)
  @JsonSerialize(using=LocalDateTimeSerializer.class)
  private LocalDateTime letztAend;
  ...
  public LocalDateTime getLetztAend() {
	return letztAend;
  }

  public void setLetztAend(LocalDateTime letztAend) {
