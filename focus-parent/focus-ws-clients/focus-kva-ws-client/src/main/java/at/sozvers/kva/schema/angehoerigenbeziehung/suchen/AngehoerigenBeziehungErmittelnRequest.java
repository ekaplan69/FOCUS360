...
/**
 * <p>Java-Klasse für angehoerigenBeziehungErmittelnRequest complex type.
 *
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 *
 * <pre>
 * &lt;complexType name="angehoerigenBeziehungErmittelnRequest"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name="angehoerigenBeziehungErmittelnRequest", propOrder={"vondat", "vsnr"})
public class AngehoerigenBeziehungErmittelnRequest {
