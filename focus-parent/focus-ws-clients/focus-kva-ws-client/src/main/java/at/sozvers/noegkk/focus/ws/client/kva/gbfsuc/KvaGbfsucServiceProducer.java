...
@ApplicationScoped
public class KvaGbfsucServiceProducer {
  ...
  private KvaGbfsucClient init() {
	...
	return new KvaGbfsucClient(url, verarbeitungsmdous, sysmodus, user, pass, quellsystem, berechtigungssystem, primaersystem);
  }
}
