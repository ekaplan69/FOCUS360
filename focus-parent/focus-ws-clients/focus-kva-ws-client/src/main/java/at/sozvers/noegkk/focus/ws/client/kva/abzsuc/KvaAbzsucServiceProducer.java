...
@ApplicationScoped
public class KvaAbzsucServiceProducer {
  ...
  public KvaAbzsucClient init() {
	...
	return new KvaAbzsucClient(url, verarbeitungsmdous, sysmodus, user, pass, quellsystem, berechtigungssystem, primaersystem);
  }
}
