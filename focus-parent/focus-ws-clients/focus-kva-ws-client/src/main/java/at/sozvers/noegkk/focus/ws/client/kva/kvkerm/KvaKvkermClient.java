...
import at.sozvers.kva.definitions.ermittle_krankenversicherungsanspruch.ErmittleKrankenversicherungsanspruchService;
...
public class KvaKvkermClient {

  private static final Logger LOG = LoggerFactory.getLogger(KvaKvkermClient.class);
  ...
  public KvaKvkermClient() {
  }

  public KvaKvkermClient(String wsUrl, String verarbeitungsmodus, String systemmodus, String username, String password, String quellsystem, String berechtigungssystem, String primaersystem) {
	this.wsUrl = wsUrl;
  ...
  public ErmittelterKrankenversicherungsanspruch ermittleKrankenanspruch_2_0(KrankenversicherungsanspruchErmittlung input, RequestHeadersCommons requestHeadersCommons) throws MalformedURLException {
	URL       wsdlURL = KvaKvkermClient.class.getResource("/wsdl/KrankenanspruchErmitteln.wsdl");
	final var client  = new ErmittleKrankenversicherungsanspruchService(wsdlURL).getErmittleKrankenversicherungsanspruchPort();

	SecuredServiceClient.createForService(client).withCredentials(username, password).withTimestamp().apply();

	addEndpoint(client, "/KVAWS/kvkerm/2_0/Krankenversicherungsanspruch");
	...
	return client.ermittleKrankenversicherungsanspruch(input);
  }
