...
/**
 * This object contains factory methods for each Java content interface and Java element interface generated in the at.sozvers.kva.schema.types package.
...
public class ObjectFactory {
  ...
  /**
   * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: at.sozvers.kva.schema.types
   */
  ...
  /**
   * Create an instance of {@link MeldungenParameter }
   */
  public MeldungenParameter createMeldungenParameter() {
	return new MeldungenParameter();
  }
}
