...
/**
 * <p>Java-Klasse für offeneKontakteErmittelnForFSResponse complex type.
 *
...
@XmlType(name="offeneKontakteErmittelnForFSResponse", propOrder={"kontakte"})
public class OffeneKontakteErmittelnForFSResponse extends StandardResponse {
  private static final long                     serialVersionUID = 1L;
  @XmlElement(nillable=true)
  private              List<KontaktkontaktKurz> kontakte;

  public OffeneKontakteErmittelnForFSResponse() {
	//Standard Contructor
  }
