...
/**
 * <p>Java-Klasse für kontaktAendernResponse complex type.
 *
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 *
 * <pre>
 * &lt;complexType name="kontaktAendernResponse">
 *   &lt;complexContent>
...
@XmlType(name="kontaktAendernResponse", propOrder={"id", "updatecount"})
public class KontaktAendernResponse extends StandardResponse {
