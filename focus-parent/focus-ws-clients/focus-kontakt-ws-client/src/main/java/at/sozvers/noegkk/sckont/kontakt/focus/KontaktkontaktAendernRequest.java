...
/**
 * <p>Java-Klasse für kontaktkontaktAendernRequest complex type.
 *
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 *
 * <pre>
 * &lt;complexType name="kontaktkontaktAendernRequest">
 *   &lt;complexContent>
 ...
 *         &lt;element name="letztAend" type="{http://www.w3.org/2001/XMLSchema}dateTime" minOccurs="0"/>
...
@XmlType(name="kontaktkontaktAendernRequest",
		 propOrder={"abschlussartId", "agd", "agdFachschluessel", "agdName", "anmerkung", "aufgabengebietId", "bundesland", "externeGewalt", "fachschluessel", "fachschluesselArtKurz", "fremdsystemId",
				 "fremdsystemName", "gemeinde", "gemeindeCode", "kontaktId", "kontaktartId", "letztAend", "letztAendName", "mitarbeiterName", "mitarbeiterOe", "mitarbeiterkennung",
				 "nacherfassenGrund", "nacherfassenText", "name", "ort", "plz", "polBezirk", "scIdMa", "staatIsoa3", "themaId", "unterthemaId", "updatecount"})
public class KontaktkontaktAendernRequest extends StandardRequest {
  ...
  protected XMLGregorianCalendar letztAend;
   ...
   */
  public XMLGregorianCalendar getLetztAend() {
	return letztAend;
  }
   ...
   */
  public void setLetztAend(XMLGregorianCalendar value) {
