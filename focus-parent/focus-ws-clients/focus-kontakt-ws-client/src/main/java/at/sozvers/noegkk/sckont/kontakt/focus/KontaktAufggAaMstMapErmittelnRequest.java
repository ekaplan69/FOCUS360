...
/**
 * <p>Java-Klasse für kontaktAufggAaMstMapErmittelnRequest complex type.
 *
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 *
 * <pre>
 * &lt;complexType name="kontaktAufggAaMstMapErmittelnRequest">
 *   &lt;complexContent>
...
@XmlType(name="kontaktAufggAaMstMapErmittelnRequest", propOrder={"mstCode"})
public class KontaktAufggAaMstMapErmittelnRequest extends StandardRequest {
