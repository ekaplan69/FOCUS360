...
/**
 * <p>Java-Klasse für kontaktAufggThemaMstMapErmittelnRequest complex type.
 *
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 *
 * <pre>
 * &lt;complexType name="kontaktAufggThemaMstMapErmittelnRequest">
 *   &lt;complexContent>
...
@XmlType(name="kontaktAufggThemaMstMapErmittelnRequest", propOrder={"mstCode"})
public class KontaktAufggThemaMstMapErmittelnRequest extends StandardRequest {
