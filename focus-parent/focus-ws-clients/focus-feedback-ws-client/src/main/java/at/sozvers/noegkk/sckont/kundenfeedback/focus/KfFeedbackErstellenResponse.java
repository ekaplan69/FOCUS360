...
/**
 * <p>Java-Klasse für kfFeedbackErstellenResponse complex type.
 *
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 *
 * <pre>
 * &lt;complexType name="kfFeedbackErstellenResponse">
 *   &lt;complexContent>
...
@XmlType(name="kfFeedbackErstellenResponse", propOrder={"id", "updatecount"})
public class KfFeedbackErstellenResponse extends StandardResponse {
