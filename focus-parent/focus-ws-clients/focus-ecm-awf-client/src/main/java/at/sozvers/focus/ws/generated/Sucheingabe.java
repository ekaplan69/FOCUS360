 ...
 *       &lt;sequence&gt;
 *         &lt;element name="suchbegriffe" type="{http://awf.sozvers.at/schema/suchen}suchbegriffe"/&gt;
...
@XmlRootElement(name="sucheingabe", namespace="http://awf.sozvers.at/schema/suchen")
public class Sucheingabe {
  ...
  @XmlElement(namespace="http://awf.sozvers.at/schema/suchen", required=true)
  protected Suchbegriffe         suchbegriffe;
   ...
   *
   * @return possible object is {@link Suchbegriffe }
   */
  public Suchbegriffe getSuchbegriffe() {
	return suchbegriffe;
  }
   ...
   *
   * @param value
   * 		allowed object is {@link Suchbegriffe }
   */
  public void setSuchbegriffe(Suchbegriffe value) {
