...
/**
 * Der FachinfoTyp definiert eine Liste an Fachinfos (Metadaten).
 *
 *
 * <p>Java-Klasse für fachinfoTyp complex type.
 *
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 *
 * <pre>
 * &lt;complexType name="fachinfoTyp"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name="fachinfoTyp", namespace="http://awf.sozvers.at/schema/suchen", propOrder={"feld"})
public class FachinfoTyp {
