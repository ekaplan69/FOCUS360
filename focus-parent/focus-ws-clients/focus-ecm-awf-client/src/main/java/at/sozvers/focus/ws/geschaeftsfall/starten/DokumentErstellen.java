...
@XmlType(name="", propOrder={"dokumentKlasse", "dokumentErweiterungen", "metadaten", "links", "anGeschaeftsfallUebergeben", "nutzID"})
@XmlRootElement(name="dokumentErstellen", namespace="http://awf.sozvers.at/schema/dokument")
