 ...
 *       &lt;sequence&gt;
 *         &lt;element name="suchbegriffe" type="{http://awf.sozvers.at/schema/suchen}amSuchbegriffe"/&gt;
...
@XmlRootElement(name="amSucheingabe", namespace="http://awf.sozvers.at/schema/suchen")
public class AmSucheingabe {

  @XmlElement(namespace="http://awf.sozvers.at/schema/suchen", required=true)
  protected ErgebnisAufbereitung ergebnisaufbereitung;
  @XmlElement(namespace="http://awf.sozvers.at/schema/suchen", required=true)
  protected AmSuchbegriffe       suchbegriffe;
   ...
   *
   * @return possible object is {@link AmSuchbegriffe }
   */
  public AmSuchbegriffe getSuchbegriffe() {
	return suchbegriffe;
  }
   ...
   *
   * @param value
   * 		allowed object is {@link AmSuchbegriffe }
   */
  public void setSuchbegriffe(AmSuchbegriffe value) {
