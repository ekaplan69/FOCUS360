...
/**
 * DokumenterweiterungenTyp kapselt eine Liste an Dokumenterweiterungen zur Sucheinschränkung.
 *
 *
...
@XmlType(name="dokumentErweiterungenTyp", namespace="http://awf.sozvers.at/schema/suchen", propOrder={"dokumentErweiterung"})
public class DokumentErweiterungenTyp {

  @XmlElement(name="dokument-erweiterung", namespace="http://awf.sozvers.at/schema/suchen")
