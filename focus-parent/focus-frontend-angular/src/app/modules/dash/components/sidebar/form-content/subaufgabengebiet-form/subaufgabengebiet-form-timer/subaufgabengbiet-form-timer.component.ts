...
@Component({
    selector: "f360-subaufgabengbiet-form-timer",
    templateUrl: "./subaufgabengebiet-form-timer.component.html",
    styleUrls: ["./subaufgabengebiet-form-timer.component.scss"],
    standalone: true,
})
export class SubaufgabengebietFormTimerComponent implements OnInit, OnDestroy {
