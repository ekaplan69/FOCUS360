...
import at.sozialversicherung.schema.zpv.ibs.clklinkinitialisieren_1_0.*;
...
@Dependent
public class DTOCLKLinkINIFactory {
  ...
  public DtoclkLinkINI createDtoclkLinkINI(String partnerId) {
	DtoclkLinkINI input = new DtoclkLinkINI();
	...
	DtoclkLinkKriterien kriterien = new DtoclkLinkKriterien();
	kriterien.setLinkTypCode("PARTNER");
	kriterien.setTechnischeID(BigInteger.valueOf(Long.parseLong(partnerId)));
	input.setDtoclkLinkKriterien(kriterien);

	//        DtoclkInitialisierungAllgemein allgemein = new DtoclkInitialisierungAllgemein();
	//        input.setDtoclkInitialisierungAllgemein(allgemein);
