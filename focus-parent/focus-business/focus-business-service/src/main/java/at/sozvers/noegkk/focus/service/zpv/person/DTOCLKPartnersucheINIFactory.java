...
import at.sozialversicherung.schema.zpv.ibs.clkpartnersucheinitialisieren_4_0.*;
...
@Dependent
public class DTOCLKPartnersucheINIFactory {
  ...
  public DtoclkPartnersucheINI createDtoclkPartnersucheINI() {
	DtoclkPartnersucheINI input = new DtoclkPartnersucheINI();
	...
	DtoclkPartnersuchKriterien partnersuchKriterien = new DtoclkPartnersuchKriterien();
	input.setDtoclkPartnersuchKriterien(partnersuchKriterien);
