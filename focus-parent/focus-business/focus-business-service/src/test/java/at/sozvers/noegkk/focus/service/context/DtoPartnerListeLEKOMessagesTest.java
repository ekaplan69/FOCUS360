...
class DtoPartnerListeLEKOMessagesTest {
  ...
  @Test
  void test_addMessage_DtoPartnerListeLEKO_withMoreMessages() {

	DtoPartnerListeLEKO dto      = new DtoPartnerListeLEKO();
  ...
  @Test
  void test_addMessage_DtoPartnerListeLEKO_withOneMessage() {
  ...
  @Test
  void test_addMessage_NoSuchMethodException() {
	DtoPartnerLEKO dto = new DtoPartnerLEKO();
	assertThrows(NoSuchMethodException.class, () -> messages.addMessage(dto));
  }

  @Test
  void test_add_Message_DtoPartnerLEKO_null() {
	DtoPartnerLEKO dto = null;
	assertThrows(NullPointerException.class, () -> messages.addMessage(dto));
  }

  @Test
  void test_add_Message_DtoPartnerListeLEKO_noMessage() {
	DtoPartnerListeLEKO dto      = new DtoPartnerListeLEKO();
	ReturnInfo          returnVO = new ReturnInfo();
	returnVO.setIstOk("ok");
	dto.setFehlerpaket(returnVO);
  ...
  @Test
  void test_add_Message_DtoPartnerListeLEKO_null() {
	DtoPartnerListeLEKO dto = null;
	assertThrows(NullPointerException.class, () -> messages.addMessage(dto));
  }
}
